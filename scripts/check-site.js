...
const checks = [
  ...
  ["uses four image-led portfolio figures", countMatches(portfolioMarkup, /class="portfolio-item(?:\s[^"]*)?"/g) === 4],
  ["keeps portfolio copy to practical captions", countMatches(portfolioMarkup, /<p\b/g) === 0 && countMatches(portfolioMarkup, /<figcaption>/g) === 4],
